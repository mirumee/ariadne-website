...
> **Note:** This is a breaking change. See the [middleware](/server/Extensions/middleware) document for new guide for developers.
...
`ExtensionSync` base class was also removed from Ariadne. Please use `Extension` as base class for custom extensions. See the [middleware](/server/Extensions/middleware) document for the guide for new middlewares what support both async and sync execution.
